...
export default function ProjectAdvise({ experience, skills, pricing, activeTab }: ProjectAdviseProps) {
    // Lọc dữ liệu dựa trên các props
    const filteredCards = ProjectAdviseData.filter((card: CardData) => {
